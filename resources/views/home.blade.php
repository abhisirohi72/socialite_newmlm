        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="row align-items-center">
                <div class="col-lg-6 about-2-secs-right mb-lg-0 mb-5">
                    <img src="{{ asset('front/assets/images/img2.jpg')}}" alt="" class="img-fluid radius-image" />
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card-single">
                        <div class="grids5-info">
                            <a href="#blog"><img src="{{ asset('front/assets/images/blog1.jpg')}}" alt="" /></a>
                            <div class="blog-info">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                        <img class="img-fluid" src="{{asset('front/assets/images/testi2.jpg')}}" alt="admin"
                    ...
                    <div class="blog-card-single">
                        <div class="grids5-info">
                            ...
                            <div class="blog-info">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                        <img class="img-fluid" src="{{asset('front/assets/images/testi1.jpg')}}" alt="admin"
                    ...
                    <div class="blog-card-single">
                        <div class="grids5-info">
                            ...
                            <div class="blog-info">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                        <img class="img-fluid" src="{{asset('front/assets/images/testi3.jpg')}}" alt="admin"
