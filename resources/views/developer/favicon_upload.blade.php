                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <!-- Vertical Form -->
                            <form class="row g-3" method="POST" action="{{ route('favicon.save') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="backend_logo" class="form-label">Backend Logo Upload</label>
                                    <input type="file" class="form-control" id="backend_logo" name="backend_logo">
                                </div>
