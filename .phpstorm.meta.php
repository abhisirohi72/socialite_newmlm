...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/mlm/mlm/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/mlm/mlm/public/storage',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','concurrency.default','cors.paths',
...
'sanctum.csrf-cookie','login','user.register',
'user.save.register','user.login','user.logout','user.dashboard','wallet',
'payout.request','approved.payout','add.personal.info','save.info','add.bank.details',
'save.bank.details','add.kyc','save.kyc','add.professional.details','add.financial.details',
'save.financial.details','add.marketing.skill','save.marketing.skill','add.availability','save.availability',
'admin.login','save.admin.login','admin.dashboard','admin.user.list','admin.user.add',
'admin.user.save','admin.user.activation','admin.genealogy.show','home',
'about','service','contact.us','storage.local',);
        registerArgumentsSet('views', 
'about','admin.dashboard','admin.genealogy.view','admin.user.activation','admin.user.add',
'admin.user.view','auth.admin.login','auth.user.login','auth.user.register','availability.add',
'bank_details.add','contact','financial_details.add','home','kyc.add',
'layouts.admin.header','layouts.admin.sidebar','layouts.app','layouts.footer','layouts.front.footer',
'layouts.front.header','layouts.front_app','layouts.header','layouts.user.header','layouts.user.sidebar',
'marketing_skills.add','personal_info.add','professional_details.add','service','user.dashboard',
